...
en_definicja: >-
  ...
  multiplied by 100.
pl_uwagi:  >-
  Wskaźnik nie jest już monitorowany w obecnej postaci. Trwają prace nad prezentacją
  wskaźnika w obecnie rozwiniętej technologii, sieci 5G.
en_uwagi:  >-
  The indicator is no longer monitored in its current form. Work is underway to present
  the indicator in the context of the currently developing technology, the 5G network.
