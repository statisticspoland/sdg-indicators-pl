...
pl_wyjasnienia_metodologiczne: >-
  ...
  <p>• z powodu choroby lub urlopu wypoczynkowego, urlopu związanego z
  ...
  szkolenia związanego z wykonywaną pracą,</p>
  <p>• z powodu sezonowego
  ...
  wyłączeniem obowiązków prawnych lub administracyjnych),</p>
  <p>• z
...
en_wyjasnienia_metodologiczne: >-
  ...
  reference week:</p>
  <p>1. performed for at least one hour any work
  ...
  activity outside agriculture,</p>
  <p>2. had work but did not perform it:</p>
  <p>• due to illness or holiday leave, leave related to parenthood
  ...
  work;</p>
  <p>• due to the seasonal character of the work, if they still
  regularly performed off-season their work or business conducting related tasks
  and responsibilities (excluding legal or administrative obligations);</p>
  <p>• for other reasons, if the anticipated break in employment did not exceed 3
  months.</p>
