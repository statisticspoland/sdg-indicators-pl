...
pl_uwagi: >-
  Niepełne szeregi czasowe dla prezentowanych wymiarów wynikają z
  braku naliczenia dla nich wartości w przypadku niektórych lat.
en_uwagi: >-
  Incomplete time series for presented dimensions are caused by the lack of
  calculated values for them for some years.
---
