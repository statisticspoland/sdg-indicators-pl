...
<p style="margin-bottom: 24px;">Znajdziesz tu zestaw wskaźników kontekstowych, dla których źródłem danych są oficjalne statystyki GUS. Zadaniem wskaźników kontekstowych jest uzupełnienie wyników statystyk eksperymentalnych, pogłębienie informacji na temat monitorowanego zjawiska oraz zapewnienie wsparcia w ocenie postępu w realizacji zrównoważonego rozwoju.</p>
	...
	<div class="grid-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); grid-gap: 5px;">
		...
		<div class="grid-child" style="width:100%; height: 500px;">
			<div style="width: 86%; display: inline-block;"><b id="tytuł_1">Powierzchnia miast w 2024 roku (km<sup>2</sup>)</b></div>
		...
		<div class="grid-child" style="width:100%; height: 500px;">
			<div style="width: 90%; display: inline-block;"><b id="tytuł_2">Dynamika zmian liczby ludności w 2024 r. (rok 2015=100)</b></div>
			<div style="width: 86%; display: inline-block;">
				<label for="wojs" style="margin-top: 0px; margin-right: 5px; max-width: 100px; display: inline; font-weight: normal;">Wybierz:</label>
...
var dane9 = [{
	"w1":"Białystok","w2":"ogółem","2015":426.9,"2024":501.9
	},
	{"w1":"Bydgoszcz","w2":"ogółem","2015":416.3,"2024":498.0
	},
	{"w1":"Gdańsk","w2":"ogółem","2015":456.9,"2024":551.2
	},
	{"w1":"Gorzów Wielkopolski","w2":"ogółem","2015":416.1,"2024":504.1
	},
	{"w1":"Katowice","w2":"ogółem","2015":470.3,"2024":580.3
	},
	{"w1":"Kielce","w2":"ogółem","2015":418.7,"2024":518.0
	},
	{"w1":"Kraków","w2":"ogółem","2015":472.9,"2024":576.7
	},
	{"w1":"Lublin","w2":"ogółem","2015":432.4,"2024":527.5
	},
	{"w1":"Łódź","w2":"ogółem","2015":502.2,"2024":598.8
	},
	{"w1":"Olsztyn","w2":"ogółem","2015":439.0,"2024":509.4
	},
	{"w1":"Opole","w2":"ogółem","2015":434.3,"2024":493.3
	},
	{"w1":"Poznań","w2":"ogółem","2015":463.4,"2024":571.9
	},
	{"w1":"Rzeszów","w2":"ogółem","2015":396.7,"2024":510.1
	},
	{"w1":"Szczecin","w2":"ogółem","2015":424.8,"2024":509.3
	},
	{"w1":"Toruń","w2":"ogółem","2015":432.6,"2024":521.5
	},
	{"w1":"Warszawa","w2":"ogółem","2015":523.3,"2024":585.9
	},
	{"w1":"Wrocław","w2":"ogółem","2015":476.0,"2024":583.8
	},
	{"w1":"Zielona Góra","w2":"ogółem","2015":415.1,"2024":493.2
	}];

	createchart1('chart1', 0, 700, 1, ['ogółem'], 0);
	createchart2('chart2', 90.0, 108.0, 1, ['ogółem'], 0);
	createchart3('chart3', dane3, ['2015', '2020', '2024']);
	...
	createchart8('chart8', dane8, ['2018', '2024']);
	createchart9('chart9', dane9, 0, 600, 0, ["2015", "2024"]);
...
function wyborWoj2() {
    ...
    console.log(selectedWoj);
		...
		if(selectedWoj===4){    
		createchart2('chart2', 94.0, 108.0, 1, ['ogółem'], 4);
		}		
		if(selectedWoj===5){    
		...
		if(selectedWoj===7){    
		createchart2('chart2', 98.0, 108.0, 1, ['ogółem'], 7);
		}
		if(selectedWoj===8){    
		createchart2('chart2', 99.0, 101.0, 1, ['ogółem'], 8);
		}		
   }
