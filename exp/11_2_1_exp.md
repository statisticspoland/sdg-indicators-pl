...
<p style="margin-bottom: 24px;">Znajdziesz tu zestaw wskaźników kontekstowych, dla których źródłem danych są oficjalne statystyki GUS. Zadaniem wskaźników kontekstowych jest uzupełnienie wyników statystyk eksperymentalnych, pogłębienie informacji na temat monitorowanego zjawiska oraz zapewnienie wsparcia w ocenie postępu w realizacji zrównoważonego rozwoju.</p>
	...
	<div class="grid-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); grid-gap: 5px;">
		...
		<div class="grid-child" style="width:100%; height: 500px;">
			<div style="width: 90%; display: inline-block;"><b id="tytuł_1">Dynamika zmian liczby ludności w 2025 r. (rok 2015=100)</b></div>
	...
	<div class="grid-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); grid-gap: 5px;">
		...
		<div class="grid-child" style="width:100%; height: 500px;">
			<div style="width: 86%;"><b id="tytuł_4">Czynne przystanki autobusowe (z trolejbusowymi) i tramwajowe na 10 km<sup>2</sup> w 2024 r.</b></div>
			<div style="width: 86%; display: inline-block;">
				<label for="wojs" style="margin-top: 0px; margin-right: 5px; max-width: 100px; display: inline; font-weight: normal;">Wybierz:</label>
	...
	<div class="grid-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); grid-gap: 5px;">
		...
		<div class="grid-child" style="width:100%; height: 500px;">
			<div style="width: 90%; display: inline-block;"><b id="tytuł_7">Liczba parkingów Park & Ride w 2024 r.</b></div>
			<div style="width: 86%; display: inline-block;">
				<label for="wojs" style="margin-top: 0px; margin-right: 5px; max-width: 100px; display: inline; font-weight: normal;">Wybierz:</label>
...
var dane2 = [{
	...
	createchart2('chart2', dane2, ['2015', '2020', '2025']);
	createchart3("chart3", 0, 500, 0, ["2015", "2024"], 0);
	createchart4('chart4', 0, 100, 1, ['ogółem'], 0);
	createchart5('chart5', dane5, ['2015', '2024']);
	createchart6('chart6', dane6, ['2015', '2024']);
...
function wyborWoj1() {
    ...
    console.log(selectedWoj);
		...
		if(selectedWoj===2){    
		createchart1('chart1', 90.0, 108.0, 1, ['ogółem'], 2);
		}
		if(selectedWoj===3){    
		createchart1('chart1', 92.0, 108.0, 1, ['ogółem'], 3);
		}
		if(selectedWoj===4){    
		createchart1('chart1', 92.0, 108.0, 1, ['ogółem'], 4);
		}		
		if(selectedWoj===5){    
		createchart1('chart1', 94.0, 108.0, 1, ['ogółem'], 5);
		}		
		if(selectedWoj===6){    
		createchart1('chart1', 96.0, 108.0, 1, ['ogółem'], 6);
		}
		if(selectedWoj===7){    
		createchart1('chart1', 96.0, 108.0, 1, ['ogółem'], 7);
		}
		if(selectedWoj===8){    
		createchart1('chart1', 98.0, 108.0, 1, ['ogółem'], 8);
		}		
		if(selectedWoj===9){    
		createchart1('chart1', 99.0, 101.0, 1, ['ogółem'], 9);
		}		
   }
...
function wyborWoj4() {
    ...
    console.log(selectedWoj);
		...
		if(selectedWoj===6){    
		createchart4('chart4', 0, 100, 1, ['ogółem'], 6);
		}
   }
...
function wyborWoj7() {
    ...
    console.log(selectedWoj);
		...
		if(selectedWoj===4){    
		createchart7('chart7', 0, 40, 0, ['ogółem'], 4);
		}		
		if(selectedWoj===5){    
		...
		if(selectedWoj===8){    
		createchart7('chart7', 0, 20, 0, ['ogółem'], 8);
		}		
   }
