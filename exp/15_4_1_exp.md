...
<!--------------Mapy---------------------------------------------->
					  <div role="tabpanel" class="tab-pane active" id="maps" style="scroll-margin-top: 500px;">
						...
						<br />
								...
								<p style="font-size: 12px;margin-top: -2em;">Dane dotyczą 2025 r.</p>
...
<p style="margin-bottom: 24px;">Znajdziesz tu zestaw wskaźników kontekstowych, dla których źródłem danych są oficjalne statystyki GUS. Zadaniem wskaźników kontekstowych jest uzupełnienie wyników statystyk eksperymentalnych, pogłębienie informacji na temat monitorowanego zjawiska oraz zapewnienie wsparcia w ocenie postępu w realizacji zrównoważonego rozwoju.</p>
	...
	<div class="grid-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); grid-gap: 5px;">
		...
		<div class="grid-child" style="width:100%; height: 500px;">
			<div style="width: 86%; display: inline-block;"><b id="tytuł_6">Powierzchnia obszarów specjalnej ochrony ptaków w powierzchni ogółem w 2025 r. (%)</b></div>
	...
	<div class="grid-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); grid-gap: 5px;">
		<div class="grid-child" style="width:100%; height: 500px;">
			<div style="width: 86%;"><b id="tytuł_7">Powierzchnia specjalnych obszarów ochrony siedlisk w powierzchni ogółem w 2025 r. (%)</b></div>
			<div style="width: 86%; display: inline-block;">
				<label for="wojs" style="margin-top: 0px; margin-right: 5px; max-width: 100px; display: inline; font-weight: normal;">Wybierz:</label>
...
var dane1 = [{"w1":"POLSKA","w2":"ogółem","2017":0.5,"2025":0.6},{"w1":"Dolnośląskie","w2":"ogółem","2017":0.5,"2025":0.6},{"w1":"Kujawsko-Pomorskie","w2":"ogółem","2017":0.5,"2025":0.6},{"w1":"Lubelskie","w2":"ogółem","2017":0.5,"2025":0.5},{"w1":"Lubuskie","w2":"ogółem","2017":0.3,"2025":0.4},{"w1":"Łódzkie","w2":"ogółem","2017":0.4,"2025":0.4},{"w1":"Małopolskie","w2":"ogółem","2017":0.2,"2025":0.3},{"w1":"Mazowieckie","w2":"ogółem","2017":0.5,"2025":0.6},{"w1":"Opolskie","w2":"ogółem","2017":0.1,"2025":0.2},{"w1":"Podkarpackie","w2":"ogółem","2017":0.6,"2025":0.7},{"w1":"Podlaskie","w2":"ogółem","2017":1.2,"2025":1.3},{"w1":"Pomorskie","w2":"ogółem","2017":0.5,"2025":0.5},{"w1":"Śląskie","w2":"ogółem","2017":0.4,"2025":0.4},{"w1":"Świętokrzyskie","w2":"ogółem","2017":0.3,"2025":0.6},{"w1":"Warmińsko-Mazurskie","w2":"ogółem","2017":1.4,"2025":1.5},{"w1":"Wielkopolskie","w2":"ogółem","2017":0.1,"2025":0.2},{"w1":"Zachodniopomorskie","w2":"ogółem","2017":0.6,"2025":0.6}];
	...
	createchart1("chart1", dane1, 0, 2, 1, ["2017", "2025"]);
	createchart2('chart2', dane2, ['2015', '2025']);
	createchart3('chart3', dane3, ['2015', '2025']);
	createchart4('chart4', dane4, ['2015', '2025']);
	createchart5('chart5', 0, 20, 1, ['ogółem'], 0);
	createchart6('chart6', 0, 35, 1, ['ogółem'], 0);
	createchart7('chart7', 0, 30, 1, ['ogółem'], 0);
	createchart8('chart8', dane8, ['2015', '2024']);
...
function wyborWoj5() {
	...
	if(selectedWoj===10){    
	createchart5('chart5', 0, 20, 1, ['ogółem'], 10);
	}
   }
...
function wyborWoj6() {
    ...
    console.log(selectedWoj);
		...
		if(selectedWoj===10){    
		createchart6('chart6', 0, 35, 1, ['ogółem'], 10);
		}
   }
...
function wyborWoj7() {
    ...
    console.log(selectedWoj);
		...
		if(selectedWoj===10){    
		createchart7('chart7', 0, 30, 1, ['ogółem'], 10);
		}
   }
