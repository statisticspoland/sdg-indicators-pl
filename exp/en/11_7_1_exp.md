...
<!---------------Metodologia------------------------------------>
						<div role="tabpanel" class="tab-pane" id="metodology" style="scroll-margin-top: 500px;">
							...
							<p>Detailed information on calculations based on the <a target="_blank" href="https://unstats.un.org/sdgs/metadata/files/Metadata-11-07-01.pdf" alt="UN methodology for 11.7.1 indicator" title="UN methodology for 11.7.1 indicator">UN methodology</a> can be found in the indicator metadata on the <a target="_blank" href="https://sdg.gov.pl/en/statistics_glob/11-7-1/" alt="UN methodology for 11.7.1 indicator" title="UN methodology for 11.7.1 indicator">SDG Platform.</a></p>
						</div>
<!--------------Źródła----------------------------------------->
