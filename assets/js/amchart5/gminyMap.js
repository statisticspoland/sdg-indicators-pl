...
function createMapGmin(div, dane, jez){
  ...
  //set ids to polygon
  for (var i = 0; i < am4geodata_gminy.features.length; i++){
      am4geodata_gminy.features[i].id = am4geodata_gminy.features[i].properties.JPT_KOD_JE;
      am4geodata_gminy.features[i].properties.value = brak_danych;
  }
