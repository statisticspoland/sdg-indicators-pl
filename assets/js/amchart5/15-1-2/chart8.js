...
function createchart8(div, dane, wymiary){
    // Create root element
    ...
    var xRenderer = am5xy.AxisRendererX.new(root, { strokeOpacity: 0.1, minGridDistance: 30 });
    ...
    function makeSeries(name, fieldName) {
      ...
      series.columns.template.setAll({
        tooltipText: "{categoryY}, {name}: {valueX.formatNumber('#,###.00')}",
