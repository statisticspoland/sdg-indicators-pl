...
kategorie: null
zmienne: null
jednostka: tys. USD (ceny bieżące)
pre: 2
graph: longitudinal
...
indicator: 17.19.1
target_id: '17.19.1'
graph_title: Wartość w dolarach wydanych ze wszystkich dostępnych zasobów w celu wzmocnienia zdolności statystycznych w krajach rozwijających się
nazwa_wskaznika: >-
...
jednostka_prezentacji: tys. USD (ceny bieżące)
